...
# Set locale to avoid perl warnings and ensure compatibility
...
# The --security-opt is retained for wider compatibility, though may not be strictly needed on all systems
